...
final List<PaymentMethod> paymentMethods = [
  PaymentMethod("assets/images/gopay.png", "GoPay", "0857-1234-5678"),
  PaymentMethod("assets/images/dana.png", "DANA", "0857-1234-5678"),
  PaymentMethod("assets/images/spay.png", "ShopeePay", "0857-1234-5678"),
  PaymentMethod("assets/images/bca.png", "BCA", "1123219391"),
];
